...
public class Example
{
    ...
    {
        string pattern = @"[A-Z]";
        string input = @"Test String:Episode IV, A NEW HOPE It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first victory against the evil Galactic
